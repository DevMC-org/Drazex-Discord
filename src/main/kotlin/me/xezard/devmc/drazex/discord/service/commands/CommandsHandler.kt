...
class CommandsHandler (
    ...
    fun registerAllHandlers(discordClient: DiscordClient) =
    ...
    fun handle(event: ApplicationCommandInteractionEvent) =
        this.findHandlerByCommandName(event.commandName)?.handle(event) ?: Mono.empty()
